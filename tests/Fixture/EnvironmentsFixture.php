...
class EnvironmentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'establishmentd_id' => ['type' => 'index', 'columns' => ['establishment_id'], 'length' => []],
            'region_id' => ['type' => 'index', 'columns' => ['region_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'environments_ibfk_2' => ['type' => 'foreign', 'columns' => ['establishment_id'], 'references' => ['Establishments', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
            'regions_ibfk_2' => ['type' => 'foreign', 'columns' => ['region_id'], 'references' => ['Regions', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'date_invitation' => '2018-09-24',
                'date_lastcall' => '2018-09-24',
                'active' => 1,
